            ...
            <div class="hero mb-4">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-3 text-center position-relative">
                        ...
                        <i class="bi bi-pencil-fill edit-icon text-dark ml-2"></i>
                    </div>
                    ...
                    <div class="col-md-3 text-md-end mt-3 mt-md-0">
                        <a href="settings.php" class="btn btn-light mb-2 w-100">Edit Profile</a>
                        <a href="resume.php" class="btn btn-outline-light w-100">Download Resume</a>
                    </div>
