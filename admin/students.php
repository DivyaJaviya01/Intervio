                ...
                <form>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="tel" class="form-control" name="phone" data-validation="required number min max" data-min="10" data-max="10">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="password" class="form-control" name="password" required data-validation="required strongPassword min" data-min="6">
                            <div id="password_error" class="text-danger small" style="display: none;"></div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="confirmPassword" class="form-label">Confirm Password</label>
                            <input type="password" class="form-control" name="password_confirm" required data-validation="required confirmPassword">
                            <div id="password_confirm_error" class="text-danger small" style="display: none;"></div>
                        </div>
                    </div>
                    <div class="mb-3">
